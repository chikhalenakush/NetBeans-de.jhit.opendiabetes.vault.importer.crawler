    ...
    public void startMouseClicks(String loginName, String loginPassword, String device, String pump, String sn, Logger logger)
        ...
        try {
            ...
            try {
                ...
                /**
                 * ******************
                 * checking if program is ran from Jar If program ran from Jar
                 * file IEWebdriver.exe file is extracted from jar and saved to
                 * current location from where jar is ran
                 *
                 */
                 ...
                 * ******************
                 * If program ran from IDE IEWebdriver.exe file is directly
                 * taken from folder
                 *
                 */
                else {
